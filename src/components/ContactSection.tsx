    ...
    <section id="contact" className="text-center">
        ...
        <div className="grid gap-6 md:grid-cols-3">
            <form
                ...
                method="POST"
                className="md:col-span-2 bg-white/50 backdrop-blur-md rounded-2xl shadow-md p-6 text-left"
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input name="name" type="text" placeholder="Your name" className="px-4 py-2 rounded-md bg-white text-gray-800" required />
                    <input name="email" type="email" placeholder="your@email.com" className="px-4 py-2 rounded-md bg-white text-gray-800" required />
                </div>
                <input name="subject" type="text" placeholder="Subject" className="w-full mt-4 px-4 py-2 rounded-md bg-white text-gray-800" required />
                <textarea name="message" placeholder="Describe your project..." rows={4} className="w-full mt-4 px-4 py-2 rounded-md bg-white text-gray-800" required />
